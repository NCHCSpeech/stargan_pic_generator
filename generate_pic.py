...
def main(config):
    ...
    # Solver
    solver = Inference(celebA_loader, config)
    while(1):
        input_str = input("What does the person look like?")
        solver.translate_pic(input_str)
...
if __name__ == '__main__':
    ...
    # Test settings
    parser.add_argument('--test_model', type=str, default='tmp')
    ...
    parser.add_argument('--log_path', type=str, default='./stargan_celebA/logs')
    parser.add_argument('--model_save_path', type=str, default='./stargan_celebA/models')
    parser.add_argument('--sample_path', type=str, default='./stargan_celebA/samples')
